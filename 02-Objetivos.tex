\chapter{Objetivos}
    ...
    \section{Específicos}
        \begin{itemize}
            ...
            \item Analizar la entropía informacional en un conjunto pequeño de moléculas (ácido fluorhídrico, agua, amoniaco y metano), las cuales tienen 10 electrones en total, con diferentes bases y métodos.
        \end{itemize}