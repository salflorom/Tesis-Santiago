\chapter{Metodología}
    ...
    % \section{Entropías de Shannon en moléculas simples}
        ...
        % Se calcularon las entropías informacionales en la densidad normalizada al número de electrones, normalizada a la unidad y relativa, tomando como densidad de referencia su máximo global. Posteriormente, se analizó el comportamiento de las tres entropías conforme incrementaba el número de enlaces.