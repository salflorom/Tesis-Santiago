\chapter{Antecedentes}
    \section{Método Monte Carlo}
        ...
        \subsection{Muestreo estratificado}
            \noindent Uno de los métodos para alcanzar la varianza $\sigma^2$ óptima consiste en subdividir la región $\Omega$ en $N_g$ subconjuntos $\omega_i$, con $i\in\{1,2,\dots,N_g\}$, de tamaño variable, a los que se llamarán incrementos o intervalos por dimensión. De ese modo, se puede integrar utilizando $N_{ev}/N_g$ puntos de muestreo aleatorios en cada $\omega_i$.
    ...
    \section{Método Las Vegas+}
        ...
        Para saber si $d_i$ es constante, se busca que $d_i$ sea considerablemente igual en cada intervalo. Sean
    ...
    \section{Entropía de Shannon}
        ...
        \subsection{Suma de las entropías de Shannon}
            ...
            Gadre, S. et al. \cite{gadre} propusieron que la suma de las entropías podría arrojar información sobre la calidad de un conjunto base que conforma a los orbitales atómicos y probó su hipótesis con los métodos y bases. Tripathi, A. et al. \cite{tripathi}, realizaron una prueba semejante, pero con la serie isoelectrónica del Berilio. Por último, H{\^o}, M. et al. \cite{ho} mostraron estudios sobre la sensibilidad de las entropías $S_{\rho}$, $S_{\Pi}$ y $S_{\rho}+S_{\Pi}$ ante pequeñas variaciones de la densidad electrónica y sobre series isoelectrónicas de átomos.
